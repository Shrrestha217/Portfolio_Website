        ...
        <div className="flex flex-col px-[4vw] md:px-[6vw] py-[4vh] min-h-screen justify-center bg-white text-[#0d3b66] dark:bg-[#111] dark:text-white transition-colors duration-300">
            <div className="flex flex-col md:flex-row gap-[5vw] items-center h-full">
                ...
                <div className="w-full md:w-1/2 h-full flex flex-col justify-center">
                    ...
                    <div className="relative border-l-[0.4vw] border-blue-700 dark:border-white pl-[2vw] md:pl-[2.5vw] space-y-[3vh]">
                            ...
                            <div key={index} className="relative group">
                                ...
                                <div className="ml-[1vw] md:ml-[1.5vw] bg-blue-50/40 dark:bg-white/5 backdrop-blur-sm p-[2vh] rounded-md border border-blue-200/30 dark:border-white/10 shadow-sm transition-transform group-hover:scale-[1.03]">
                                    <div className="flex items-center gap-[1vw] mb-[0.5vh]">
                                        <GraduationCap size={18} className="text-blue-700 dark:text-[#1dbce3]" />
                                        <h3 className="text-[1.1vw] font-semibold min-[320px]:text-[15px]">{item.title}</h3>
                                    </div>
                                    <p className="text-[0.95vw] text-blue-900/70 dark:text-white/60 italic min-[320px]:text-[13px]">
                                        {item.institution} &middot; {item.date}
                                    </p>
                                    <p className="mt-[0.5vh] text-[0.95vw] text-blue-900 dark:text-white/85 leading-snug min-[320px]:text-[13px]">
                                        {item.description}
                                    </p>
                                </div>
                            </div>
                ...
                <div className="hidden md:flex w-1/2 h-full justify-center items-center">
                    <img
                        ...
                        className="w-full max-w-[90%] max-h-[65vh] object-contain rounded-md shadow"
                    />
                </div>
            </div>

            <div className="mt-[4vh] flex flex-col items-center self-center group">
                <button
                    onClick={onScrollToSkills}
                    className="bg-gradient-to-l from-[#1dbce3] to-[#040d5ae6] py-[1.5vh] px-[3vw] rounded font-bold text-white hover:scale-110 transition-transform"
                >
                    Skills
                </button>
                <ArrowDown
                    className="mt-[0.7vh] dark:text-white text-blue-900 transition-all duration-300 group-hover:translate-y-[0.6vh] group-hover:scale-110"
                    size={24}
                />
            </div>
        </div>
